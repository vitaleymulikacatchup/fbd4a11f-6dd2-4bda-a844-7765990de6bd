...
export const metadata: Metadata = {
  title: "Medical Cannabis Store - Licensed Care & Products",
  description: "Professional medical cannabis dispensary offering expert consultations, lab-tested products, and HIPAA-compliant care for qualified patients.",
  keywords: "medical cannabis, dispensary, CBD, THC, licensed pharmacy, patient care",
  metadataBase: new URL("https://medicarecanabis.com"),
  alternates: {
    canonical: "https://medicarecanabis.com"
  },
  openGraph: {
    title: "MediCare Cannabis - Licensed Medical Dispensary",
    description: "Professional medical cannabis care and products for qualified patients",
    type: "website",
    siteName: "MediCare Cannabis",
    url: "https://medicarecanabis.com",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764003656205-bs4tjwbp.jpg",
        alt: "Medical cannabis professional care"
      }
    ]
  },
  twitter: {
    ...
    title: "MediCare Cannabis - Licensed Medical Dispensary",
    description: "Professional medical cannabis care for qualified patients",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SiMkwDFagCJqdtr8SgryeO9Cj/uploaded-1764003656205-bs4tjwbp.jpg"]
  },
  robots: {
    index: true,
    follow: true
